...
const Confirmation: React.FC = () => {
  ...
  useEffect(() => {
      const details: AppointmentDetails = {
        ...
        gender: searchParams.get("appointmentType") || "",
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="flex items-center space-x-3">
              <div className="h-5 w-4 rounded-full bg-blue-100 flex items-center justify-center">
            ...
            {/* Email */}
            <div className="flex items-center space-x-3">
              <div className="h-5 w-4 rounded-full bg-purple-100 flex items-center justify-center">
          ...
          {/* Phone */}
          <div className="flex items-center space-x-3">
            <div className="h-5 w-4 rounded-full bg-green-100 flex items-center justify-center">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {/* Date */}
            <div className="flex items-center space-x-3">
              <div className="h-5 w-4 rounded-full bg-amber-100 flex items-center justify-center">
            ...
            {/* Time */}
            <div className="flex items-center space-x-3">
              <div className="h-5 w-4 rounded-full bg-indigo-100 flex items-center justify-center">
