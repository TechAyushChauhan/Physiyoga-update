  ...
  <div className="flex items-center space-x-3">
    ...
    <div className="flex-1 space-y-1">
      ...
      <p className="text-base text-gray-900">{appointmentDetails.email}</p>
            ...
            {/* Phone */}
            <div className="flex items-center space-x-3">
              <div className="h-8 w-1 rounded-full bg-green-100 flex items-center justify-center">
            ...
            {appointmentDetails.message && (
              <div className="flex items-start space-x-3">
                <div className="h-8 w-1 rounded-full bg-rose-100 flex items-center justify-center">
